            ...
            <div className="col s12 m4 l8"><p></p>
                <nav className="amber lighten-2">
                        <div className="nav-wrapper black-text text-darken-2">
                          ...
                          <span className="black-text text-darken-2">Yummy Recipes 
                          </span></a>
                          <ul id="nav-mobile" className="right hide-on-med-and-down">
                            <li> <button className=" btn-small amber lighten-2" 
                            onClick={this.logOutUser}>  <span className="black-text text-darken-2">Logout</span> </button> </li>
